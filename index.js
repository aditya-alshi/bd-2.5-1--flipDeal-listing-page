...
// Function to sort products by popularity high to low
function sortProductsByPopularityHighToLow(product1, product2){
...
app.get('/products/sort/popularity', (req, res) => {
  ...
  let sortedProducts = productsCopy.sort(sortProductsByPopularityHighToLow);
...
// Function that returns the products if it meets the selected RAM configuration
...
// Function that returns the products if it meets the selected ROM configuration.
...
// Function that returns the products for the specified brand category
...
// Function that returns the products for the specified OS configuration
...
// Function that returns the products for the products less than or equal to the specified price filter.
